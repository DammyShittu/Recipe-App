...
RSpec.describe Recipe, type: :model do
  it 'valid if name is present' do
    ...
    @recipe = @user.recipes.create(name: "Chapo", preparation_time: 30, cooking_time: 150, description: "new testts", public:true)
  ...
  it 'Must be associated with a user' do
    @recipe = Recipe.create(name: "Chapo", preparation_time: 30, cooking_time: 150, description: "new testts", public:true)
    expect(@recipe).to_not be_valid
  end
